					  ...
					  <div class="table-area col-md-12">
							<table class="table v3">
								...
								<tr>
									...
									<td><input type="text" class="form-control" style="width: 50%;" value="" name="sid" id="sid" onkeydown="onlyNumberLimit(this,4)";><button type="button" class="btn btn-outline-primary btn-sm ml-2" style="vertical-align: top;" onclick="validateId()">중복확인</button>
									<br><br><span class="text-primary " style="display:none" id="sid-validate-txt"></span>
									</td>
									<th>발전소명<span class="necessary">*</span></th>
									<td><input type="text" class="form-control" style="width: 50%;" value="" name="name" id="name"><button type="button" class="btn btn-outline-primary btn-sm ml-2" style="vertical-align: top;" onclick="validateName()">중복확인</button>
								...
								<tr>
									<th>발전소 사진</th>
									<td colspan="3"><input type="file" id="file" class="form-control" style="width: 80%;" ></td>
								</tr>
								<tr>
									<th>메모</th>
...
//발전소 이미지 등록
		...
		if ($("#file").val() ){
			...
			var settings = {
			  "async": true,
			  "crossDomain": true,
			  "url": "http://118.44.161.63:8081/api/sites/"+$("#sid").val()+"/image",
			  "method": "PUT",
			  "headers": {
			    "authorization": "<%=authorization%>",
			    "cache-control": "no-cache"
   ...
   function createNewDeviceHtml(type){
	   	...
	   	newDeviceHtml += '<td><input type="text" class="form-control" value="" name="deviceid" onblur="checkDivcieIdDuplication(this,\''+type+'\')" ></td>';
		newDeviceHtml += '<td><input type="text" class="form-control" value="" name="deviceName"></td>';
		newDeviceHtml += '<td><input type="text" class="form-control" value="" name="latitude"></td>';
		newDeviceHtml += '<td><input type="text" class="form-control" value="" name="longitude"></td>';
		newDeviceHtml += '<td>';
