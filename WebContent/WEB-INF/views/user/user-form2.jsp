					  ...
					  <form id="form" action="/admin/user/update" method="post">
							<table class="table v3">
								...
								<tr>
									...
									<td>
										<select class="form-control" style="width: 50%;" name="roles" id="roles" readonly>
								...
								<tr>
									...
									<td>
										<input type="text" class="form-control" name="tel" id="tel" value="" style="width: 50%;" readonly>
						...
						<div class="col-md-12 text-right mb-2 mt-3"><button type="button" onclick="doSave()" class="btn btn-primary mr-2">수정</button><!-- <button type="submit" class="btn btn-primary">삭제</button> --></div>
					</div>
				</div>
			</div>
          </div>
...
<script>
	...
	function doSave() {
		...
		var settings = {
		  "async": true,
		  "crossDomain": true,
		  "url": "<%=API_HOST%>/api/users/"+$("#tel").val(),
		  "method": "PUT",
		  "headers": {
