							...
							<table class="table v3">
							  <tbody>
								<tr>
								  ...
								  <td class="text-right" id="benefit">0 원</td>
								</tr>
							  </tbody>
							</table>
						</div>
						...
						<div class="table-area col-md-12" id="printarea">
							...
							<table class="table v2" id="details">
							  <thead>
								<tr>
								  <th rowspan="2">일자</th>
								  <th rowspan="2">태양광발전량<br>[kW]</th>
								  <th rowspan="2">충전량<br>[kW]</th>
								  <th rowspan="2">방전량<br>[kW]</th>
								  <th colspan="3">PV </th>
								  <th colspan="3">ESS</th>
								  <th rowspan="2">예상 수익 (원)</th>
								</tr>
								<tr>
								  <th style="width:20px;">SMP 단가</th>
								  <th style="width:10px;">가중치</th>
								  <th>수익</th>
								  <th>REC 단가</th>
								  <th style="width:10px;">가중치</th>
								  <th>수익</th>
...
<!--      -->
	...
	function initCalendar2(format){
		
		
		
		if (!format || format == 'yy-mm'){
			$("#sdate").yearpicker('destroy');
	...
	function initCalendar_ful(format){
		console.log("initCalendar:" + format);
		datepicker_default = {
	            closeText : "닫기",
	            prevText : "이전달",
	...
	function goPage(iPage){
		curPage = iPage;
		displayBenefit(m_period, dataList);
	}
