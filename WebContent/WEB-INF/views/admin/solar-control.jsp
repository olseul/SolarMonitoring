...
<%@ include file="./LNB.jsp" %>
    ...
    %>
 <!-- partial -->
 		<input type="hidden" id="last_modecode" value="1"/> 
 		<input type="hidden" id="last_automode" value="false"/> 
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">HOME | 태양광 | 장치제어 명령 전송</h4>
					...
					<div class="row"><!-- cont01 -->
					  <div class="col-md-3 grid-margin stretch-card">
						<div class="card">
						  <div class="card-body">
							<div class="row">
								<a href="javascript:selectMode(1);" class="sel-night mode1 control-mode">
					  ...
					  <div class="col-md-3 grid-margin stretch-card">
						<div class="card">
						  <div class="card-body">
							<div class="row">
								<a href="javascript:selectMode(2);" class="sel-rain mode2 control-mode">
									<div class="weather-circle">
					  ...
					  <div class="col-md-3 grid-margin stretch-card">
						<div class="card">
						  <div class="card-body">
							<div class="row">
								<a href="javascript:selectMode(3);" class="sel-wind mode3 control-mode">
									<div class="weather-circle">
					  ...
					  <div class="col-md-3 grid-margin  stretch-card">
						<div class="card">
						  <div class="card-body">
							<div class="row">
								<a href="javascript:selectMode(4);" class="sel-snow mode4 control-mode">
									<div class="weather-circle">
	...
	function displaySolarMode(datas) {
	...
	function displaySolarState(datas){
		...
		$("#last_modecode").val(datas.modecode);
		$("#last_automode").val(!datas.isauto);
		modecode = datas.modecode;
	...
	function displayUpdateControl(datas){
		...
		var modes = ['NONE', 'NIGHT','RAIN', 'WIND','SNOW'];
