...
<%@ include file="./LNB.jsp" %>
 ...
 <!-- partial -->
 		<input type="hidden" id="last_opstate" value="false"/> 
                    ...
                    <div class="row operation">
						...
						<div class="col-md-8">
							<div class="text-right setting-switch">
								<span>정지</span>
								<label class="switch ">
								  <input type="checkbox" class="success" id="control-operate" onclick="changeOperate(this)">
			  ...
			  <div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
				  ...
				  <div class="modal-body">
					<span id="modal-msg">ESS 장치가 없습니다.</span>
	...
	$(document).ready(function(){
		...
		setInterval(function(){ start(); }, 60 * 1000);
	...
	function displayEssData(datas){
		...
		if (!datas) {
			...
			document.getElementById("control-operate").disabled = true;
		...
		if (datas && datas.bmsdata){ 
		   ...
		   var ctx = document.getElementById("play1Chart");
			...
			window.playChart1 = new Chart(ctx, {
			  type: 'doughnut',
			  data: datas1,
			  options: {
				  //options defined
	...
	function displayEssState(datas){
		...
		$("#last_opstate").val(datas.isoperating);
	...
	function changeOperate(control){
		...
		$("#control-operate").prop("disabled","disabled");
		
		if ($(control).prop("checked")){
			update_ess_state(sid, 0, $(control), $("#last_opstate").val() == 0 ? "false" : $("#last_opstate").val() == 1 ? true : false);
		} else {
			update_ess_state(sid, 1, $(control), $("#last_opstate").val() == 0 ? "false" : $("#last_opstate").val() == 1 ? true : false);
		}
	}
		//canvas
