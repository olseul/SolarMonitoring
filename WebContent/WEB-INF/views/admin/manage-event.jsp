            ...
            <div class="row">
				<div class="w-box">
						  ...
						  <div class="row">
							<div class="col-md-10">
								<div class="form-group row">
									<div class="col-sm-10">
									  <label class="col-sm-1 col-form-label"  style="text-align: right;">기간</label>
					...
					<div class="row"><!-- cont02 -->
						<div class="col-md-12 text-right mb-2"><button type="button" onclick="excelDownload();" class="btn btn-primary btn-sm mr-2">엑셀다운</button><button type="button" onclick="content_print();" class="btn btn-primary btn-sm">프린트</button></div>
...
<!--      -->
	...
	function displayEventlist(datas){
		...
		if (!datas.events || datas.events.length == 0){
			item += '<td class="text-center eventpage_date-col">-</td>';
			/* item += '<td class="text-right">-</td>'; */
			item += '<td class="text-left eventpage_event-col">-</td>';
			item += '</tr>';  
		...
		for(i=0; i<datas.events.length ; i++) {
			...
			var item = ' <tr>';
				item +='<td class="text-center eventpage_date-col">'+datas.events[i].reg_date+'</td>';
			/* 	item +='  <td class="text-center">'+datas.events[i].name+'</td>'; */
				item +='  <td class="text-left eventpage_event-col">'+datas.events[i].eventphase+'</td>';
				item +='</tr>';
